...
<html class="loading" lang="en" data-textdirection="rtl">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('assets/admin/css-rtl/cairo.css')  }}">
        ...
        <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/css-rtl/pages/users.css') }}">
        ...
        <style>
            body,h1,h2,h3,h4,h5,h6,a,p,span,ul,li,div,section {
...
<script src="{{ asset('assets/admin/vendors/js/editors/summernote/summernote.min.js') }}" type="text/javascript"></script>
<script src="{{ asset('assets/admin/vendors/js/editors/summernote/lang/summernote-es-ES.js') }}" type="text/javascript"></script>
